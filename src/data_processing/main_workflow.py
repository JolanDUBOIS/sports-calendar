...
def data_processing_workflow(db_repo: str, instructions_path: str|Path, manual: bool = False):
    """ TODO """
    ...
    for operation_name, operation_workflow in ORDER_OF_OPERATIONS.items():
...
if __name__ == "__main__":
    ...
    db_repo = get_config("db.path")
    instructions_path = "src/data_processing/instructions"
    data_processing_workflow(db_repo, instructions_path)
    logger.info("Data processing workflow completed.")
