...
# def _sessions_filter_body(filter: SelectionFilter):
#     with ui.column():
#         # Line 1 - Sessions Filter with Sessions: {session1}, {session2}, ... # Max 5 sessions, then "and X more"
#         ui.label(f'Sessions Filter with Sessions: {_format_list_with_limit(filter.sessions)}')
...
#     FilterType.SESSIONS: _sessions_filter_body,
# }